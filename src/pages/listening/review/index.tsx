...
const Reading = ({ getLayout }: any) => {
  ...
  return (
    <div className="w-full content-exam">
      ...
      <div className="lg:flex items-center h-[calc(100vh-170px)] lg:h-[calc(100vh-167px)] zoomin-content overflow-y-hidden">
        <div className="relative lg:w-[50%] w-full md:h-full h-[50%] overflow-auto" id="screen-question">
          <div className="">
            {quiz?.listening && (
