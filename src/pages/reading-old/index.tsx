...
const Reading = ({ getLayout }: any) => {
  ...
  const contentNote = { content: answerListStore?.[0]?.note, explanation: quiz?.parts?.[indexPart]?.explanation };
    ...
    <div>
      {loading ? (
        ...
        <div className="w-full content-exam">
          ...
          <HeaderUI part="Reading" title={quiz?.title} />
          <div className="zoomin-content overflow-y-hidden">
            <div className="lg:flex items-center lg:h-[calc(100vh-133px)] h-[calc(100vh-135px)]">
              <div className="relative lg:w-[50%] lg:h-[calc(100vh-133px)] h-[50%] question-ui overflow-y-scroll lg:overflow-y-hidden" id="screen-question">
                <div className="lg:h-[calc(100vh-133px)]">
              ...
              <div className="relative lg:border-[0px] border-[2px] border-neu5 lg:w-[50%] lg:h-full h-[50%] bg-neu7 overflow-y-scroll">
                <div className="lg:min-h-[calc(100%-48px)] py-[35px] px-[20px] lg:px-[50px] overflow-hidden lg:overflow-scroll">
                  {sortData
