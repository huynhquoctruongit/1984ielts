...
const WritingSelfPractice = ({ getLayout }: any) => {
    ...
    <div>
      {loading ? (
        ...
        <div className="w-full">
          <HeaderUI quiz={quiz} listAnswer={listAnswer} part="WritingPractice" title={quiz?.title} />
          <div className={`zoomin-content overflow-y-hidden lg:flex items-center lg:h-[calc(100vh-64px)]`}>
            <div className="relative lg:w-[50%] lg:h-[calc(100vh-64px)] h-full md:h-[50%]">
