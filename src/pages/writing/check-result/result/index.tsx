    ...
    <div className="bg-white content-exam">
      ...
      <div className="md:mx-[40px] md:my-[32px] m-[20px] zoomin-content overflow-y-hidden">
        <div className="md:flex md:items-center w-full">
          <div className="md:w-[110px] md:h-[110px] w-[60px] h-[60px] object-cover">
            {(profile.avatar && <img className="rounded-full md:w-[110px] md:h-[110px] w-[60px] h-[60px] object-cover" src={`${domain + "/assets/" + profile.avatar}`} />) || (
              <img src="/images/result-2.png" className="rounded-full w-full h-full md:w-full md:h-full object-fit" />
            )}
          </div>
                  ...
                  <div className="mb-[12px]">
                    <div className="flex mb-[7px]">
                      <div
                        ...
                        className={
                          "mr-[12px] bg-warning-400 whitespace-nowrap md:ml-auto text-white hover:text-white hover:bg-warning-500 px-5 shadow-sm py-2 w-fit rounded-full flex items-center transition-color duration-200 ease-in-out cursor-pointer "
                        }
                      >
                    ...
                    <div className="flex mb-[7px]">
                      ...
                      <Button className="body4 bg-neu4 text-black md:ml-auto whitespace-nowrap">Under review</Button>
                    </div>
                  )}
              </div>
            </div>
              ...
              <div className="mt-[50px]">
                ...
                <div className="ml-[12px]">
                  <div className="flex items-center relative">
                    ...
                    <div className="bg-black-border bg-neu5 mt-[14px] rounded-[10px] p-[20px] w-full overflow-hidden">
