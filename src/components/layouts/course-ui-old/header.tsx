...
import { BookIcon, WritingIcon, HeadphoneIcon, SpeakingIcon, ArrowSolidIcon } from "@/components/icons/index";
...
const Header = ({ part, title, listAnswer, quiz }: any) => {
  ...
  const isStudent = profile?.role?.name === "End User"

  const Icon = (part: any) => {
    switch (part) {
      case "Writing":
        return <WritingIcon width="22px" height="22px" />;
      case "WritingPractice":
        return <WritingIcon width="22px" height="22px" />;
      case "Reading":
        return <BookIcon width="22px" height="22px" />;
      case "Listening":
        return <HeadphoneIcon fill="white" width="22px" height="22px" />;
      case "Speaking":
        return <SpeakingIcon width="22px" height="22px" />;
      default:
        break;
    }
  };
  ...
  return (
    <div>
      ...
      <div className="header-part bg-primary1 lg:px-[39px] px-[20px] py-[18px] relative z-[11] h-[100px] md:h-[64px]">
