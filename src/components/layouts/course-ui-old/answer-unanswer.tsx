              ...
              <div className="bottom-[76px] w-[50%] py-[18px] rounded-tr-[40px] w-full">
                <div className="flex items-center text-white">
                  <div className="flex mr-[36px] items-center">
                    ...
                    <p className="body1 ml-[12px]">Answered</p>
                  </div>
                  <div>
                    <div className="flex items-center">
                      <div className="p-[3px] rounded-full bg-white w-[30px] h-[30px]"></div>
                      <p className="body1 ml-[12px]">Unanswered</p>
                    </div>
                  </div>
                </div>
                <div className="flex items-center mt-[12px] body3 flex-wrap gap-y-[10px]">
