    ...
    <div ref={ref} className="bg-white lg:min-w-[500px] w-[90%] mx-auto text-center p-[30px] rounded-[20px]">
      <div className="m-auto">
        ...
        <div className="mt-[40px] mb-[40px]">
          <div id="countdown">
            <div className="py-[20px] px-[30px] rounded-full w-fit m-auto border-[5px] border-neu5 headline1 text-primary1" id="number-count">5</div>
            <svg id="svg-border">
        ...
        <div className="flex items-center justify-center mt-[29px]">
          <button onClick={onClose} className="caption lg:body3 bg-white lg:px-[30px] px-[20px] h-[40px] box-shadow mr-[20px] rounded-[10px]">
            Ở lại bài học này
          </button>
