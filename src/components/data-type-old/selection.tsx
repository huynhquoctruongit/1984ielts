              ...
              <div className="flex items-center">
                {review ? (
                  <div
                    ...
                    } cursor-not-allowed h-[31px] p-[5px] rounded-[4px] whitespace-nowrap text-white body3 flex items-center justify-between`}
                  >
                    <p>{check?.[0]?.answer}</p>
              ...
              return (
                <div className="mb-[20px]">
                  <div className="flex items-center justify-between flex-wrap gap-y-[20px]">
                    <div className="bg-[#e7e5e1] px-[20px] min-w-[200px] rounded-[8px] flex items-center mr-[22px]">
                      <span className="body3">Answer</span>
                      <span className="headline1 text-green ml-[10px] whitespace-nowrap">{itemRender.answer}</span>
                    </div>
                    <div className="flex items-center">
